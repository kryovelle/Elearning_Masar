...
<title>Masar — Teacher Dashboard</title>
...
<header class="teacher-header">
  <nav class="teacher-nav">
    ...
    <div class="nav-right">
      ...
      <button id="logoutBtn" class="btn-logout" data-i18n="teacher_logout">Log out</button>
    </div>
  </nav>
</header>
    ...
    dropdown.innerHTML = `
        <div class="logout-dropdown-menu">
            <div class="logout-option" data-action="logout">
                ...
                <span data-i18n="teacher_logout_this_device">Logout from this device</span>
            </div>
            <div class="logout-option" data-action="logoutAll">
                <i class="fas fa-sign-out-alt"></i>
                <span data-i18n="teacher_logout_all_devices">Logout from all devices</span>
            </div>
            <div class="logout-option cancel" data-action="cancel">
                <i class="fas fa-times"></i>
                <span data-i18n="teacher_cancel">Cancel</span>
            </div>
        </div>
    `;
